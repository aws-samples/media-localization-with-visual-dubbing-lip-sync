...
if __name__ == "__main__":
    ...
    src_latest_model_artifact = max(glob.glob("/opt/ml/code/training/default/finetune/models/*.pth"), key=os.path.getctime)
    dest_dir = "/opt/ml/model/autoregressive.pth"
    dest = shutil.move(src_latest_model_artifact, dest_dir) 
